...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(150)) {
        ...
        myObstacles.push(new component(40, height, "images/pipe-green-down.jpg", x, 0, "image"));
        myObstacles.push(new component(40, x - height - gap, "images/pipe-green.jpg", x, height + gap, "image"));
    }
    for (i = 0; i < myObstacles.length; i += 1) {
        myObstacles[i].x += -1;
